...
3. **產業分布**：製造業是中型企業受害者中最大的族群，占 26%（報告原文：9,781 件中型企業事件中製造業占 **2,521 件**），比其後兩個產業（專業／科學／技術服務業、營建業）加起來還多。占比並非持平而是持續上升：2023 年 20.7%、2025 年達 28.0% 高點、2026 上半年回落至 27.0%。來源：Black Kite 原始報告（2026-08-18，逐項數字出處）、Infosecurity Magazine（2026-08-18，26% 一數）、Black Kite 新聞稿（2026-08-18，記為「逾 25%」）。
...
6. **能力落差**：中型供應商、小型軟體發行商與開源維護者無法取得每年成本 50 萬至 200 萬美元的資安工具，平均仍需 197 天偵測、60 天修補。來源：Black Kite《2026 Supply Chain Vulnerability Report》（工具成本 50 萬至 200 萬美元一節的出處）、Black Kite 原始報告（2026-08-18，以「follow-on analysis」引用 197／60 天）。**注意：此組數字不在 8/18 新聞稿內**，新聞稿全篇未出現 197、60、14、21 或工具成本，引用時勿掛新聞稿。
7. **落差的另一半（AI Gap 的實質）**：相對地，已導入 AI 弱點掃描的大型企業平均將偵測壓縮至 **14 天**、修補至 **21 天**。197 天對 14 天、60 天對 21 天——這組對照才是報告副標「Widening AI Gap」的具體內容，也是寫作時最有說服力的一組數字。隨企業邊界因 AI 防禦而變硬，攻擊者正把重心移向這些「Tier 2」供應商。來源：Black Kite 原始報告（2026-08-18）、Black Kite《2026 Supply Chain Vulnerability Report》。（兩份報告都載有這組 197／60 對 14／21 天的對照；8/18 新聞稿則完全沒有這組數字。）

8. **本輪新增查得的一手數據**（皆取自報告頁原文，可強化說服力）：
   - 受害者規模再往下：**超過一半**的中型企業受害者年營收低於 5,000 萬美元；報告採 Dun & Bradstreet 營收定義、不設員工人數門檻，分為 1,000 萬–5,000 萬、5,000 萬–5 億、5 億–10 億三個級距。
   - 外部掃描面：120,128 家中，**33,955 家（28.3%）** 至少有一個對外系統帶有已知遭利用漏洞（KEV）；比率由低營收級距的 23.9% 升至高營收級距的 52.0%，Black Kite 認為主因是攻擊面較大而非防護較差。
   - 攻擊者輪替極快：2023 年對中型企業活躍的 60 個勒索軟體團體，到 2026 上半年只剩 17 個仍活躍；Qilin 以 928 名受害者成為資料集中最活躍者。以「特定團體」為中心的防禦計畫保鮮期很短。
   - 區域反轉：9,781 件中型企業事件中北美 7,079 件、歐洲 2,702 件，但 2026 上半年歐洲年增 47.3%、北美減少 10.8%。
   - 漏洞優先化的實據：2025 年公布逾 48,000 個 CVE，實際遭利用者約 800 個（1.6%），其中對企業供應鏈構成真實威脅者僅 58 個。
   - AI 落差的第三個切面：**36.7%** 可經 OSINT 發現的供應鏈風險，如今落在中型與利基供應商這條長尾上；ISC2 2025 年調查顯示僅 **20%** 的中型企業將 AI 導入資安維運。
   來源：Black Kite 原始報告（2026-08-18）、Black Kite 新聞稿（2026-08-18，KEV 28.3% 與 ISC2 20% 一節）。

### 查證與限制
**2026-08-19 / 2026-08-20 前兩輪查證的限制**：當時網路政策以 403 阻擋 blackkite.com、prnewswire.com 與 infosecurity-magazine.com 的直連，只能以搜尋索引內容核對。

**2026-08-20 第三輪查證結果（網路限制已解除）**：Black Kite 中型企業報告頁、《2026 Supply Chain Vulnerability Report》頁、PR Newswire 新聞稿全文、Infosecurity Magazine 全數開啟原文逐條比對。

- **逐字核對無誤**：報告名稱《Mid-Market Is the Routine Target: Ransomware, Third-Party Risk, and the Widening AI Gap》、發布日 2026-08-18（新聞稿標註 Aug 18, 2026, 06:00 ET，發自 BOSTON）、13,336 件具可查證營收的勒索事件（2023 年 1 月–2026 年 6 月、北美與歐洲）、120,128 家外部掃描樣本、73%、中型企業定義為年營收 1,000 萬至 10 億美元、占比 74.6%／72.1%／74%／72.3%、事件總量 2,320 → 3,340（成長 44%）、製造業為最大族群且其後為專業／科學／技術服務業與營建業、Black Kite 首次將中型企業當成獨立區隔研究——全部與原文一致。
- **已更正（來源歸屬，本輪最重要的一處）**：前一輪把「每年 50 萬至 200 萬美元的資安工具、197 天偵測、60 天修補、大型企業 14／21 天」掛在 **8/18 新聞稿**名下。開啟新聞稿全文比對後確認：**新聞稿完全沒有這組數字**（197、60、14、21、50 萬、200 萬皆不存在）。實際出處是——工具成本 50 萬至 200 萬美元出自《2026 Supply Chain Vulnerability Report》；197／60 對 14／21 天則兩份報告都有，中型企業報告是以「follow-on analysis」的方式引用。論點 6、7 的來源標註已改正。
- **已補強（製造業占比）**：26% 一數出自 Infosecurity Magazine，新聞稿寫的是「逾 25%」。報告原文給的是更硬的數字：9,781 件中型企業事件中製造業 **2,521 件**，且占比從 2023 年 20.7% 一路升到 2025 年的 28.0% 高點、2026 上半年 27.0%。原稿只寫「占 26%」會讓讀者以為是持平，實際是上升趨勢，已補上。
- **已確認**：「製造業對停機容忍度低、持有高敏感資料」確為 Infosecurity Magazine 的歸因說明而非報告的量化發現，原稿措辭正確，維持不變。
- **新增查得**：超過一半的中型企業受害者年營收低於 5,000 萬美元；120,128 家中有 33,955 家（28.3%）帶有 KEV，比率自 23.9% 升至 52.0%；2023 年 60 個活躍勒索團體到 2026 上半年僅剩 17 個，Qilin 以 928 名受害者居首；歐洲 2026 上半年年增 47.3%、北美減少 10.8%；2025 年逾 48,000 個 CVE 中僅約 800 個（1.6%）遭實際利用、僅 58 個對企業供應鏈構成真實威脅；36.7% 的可 OSINT 發現供應鏈風險落在長尾供應商；ISC2 2025 年調查僅 20% 中型企業將 AI 導入資安維運。已整理為論點 8。
- **仍需注意**：報告完整版 PDF 需填表下載，本輪核對的是 Black Kite 官方報告頁的公開摘要與新聞稿全文，兩者數字一致；PDF 內的分項圖表未逐頁核對。
